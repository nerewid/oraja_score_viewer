const translations = {
    ja: {
        ...
        'folder.load_selected': '選択したプレイヤーを読み込む',
        'folder.loading': '読み込み中...',
        'folder.multiple_profiles': '複数のプレイヤーが見つかりました。読み込むプレイヤーを選択してください。',
    ...
    en: {
        ...
        'folder.load_selected': 'Load selected player',
        'folder.loading': 'Loading...',
        'folder.multiple_profiles': 'Multiple players found. Please select which player to load.',
