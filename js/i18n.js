const translations = {
    ja: {
        ...
        'folder.success': '「{player}」のデータを読み込みました。',
        'folder.error_generic': 'フォルダの読み込みに失敗しました。',
        'folder.error_not_beatoraja': 'beatorajaフォルダではないようです（config_sys.json が見つかりません）。',
        'folder.error_no_songdata': 'songdata.db が見つかりませんでした。',
        'folder.error_no_player': 'player フォルダが見つかりませんでした。',
        'folder.error_no_profiles': 'score.db を含むプレイヤーフォルダが見つかりませんでした。',
        'folder.error_no_scorelog': '選択したプレイヤーに scorelog.db が見つかりませんでした。',
        'folder.error_load': 'データベースの読み込みに失敗しました: ',
        'folder.fallback_hint': ' 下の「手動でファイルを個別に選択する」からもご利用いただけます。',
        ...
        'heatmap.notes': '打鍵数',
        'heatmap.progress': '更新数',
        'heatmap.updates': '回更新',
        'heatmap.unit_notes': 'notes',
        'heatmap.unit_updates': 'updates',
        'heatmap.range': '直近{months}ヶ月',
        'heatmap.play_days': '{days}日プレー',
        'heatmap.show_monthly': '月別を表示',
        'heatmap.hide_monthly': '月別を隠す',
        'heatmap.day_suffix': '日',
    ...
    en: {
        ...
        'folder.success': 'Loaded data for "{player}".',
        'folder.error_generic': 'Failed to read the folder.',
        'folder.error_not_beatoraja': 'This does not look like a beatoraja folder (config_sys.json not found).',
        'folder.error_no_songdata': 'songdata.db could not be found.',
        'folder.error_no_player': 'The player folder could not be found.',
        'folder.error_no_profiles': 'No player folder containing score.db was found.',
        'folder.error_no_scorelog': 'scorelog.db was not found for the selected player.',
        'folder.error_load': 'Failed to load database: ',
        'folder.fallback_hint': ' You can also use "Select files manually instead" below.',
        ...
        'heatmap.unit_notes': 'notes',
        'heatmap.unit_updates': 'updates',
        'heatmap.range': 'Last {months} months',
        'heatmap.play_days': '{days} days played',
        'heatmap.show_monthly': 'Show monthly',
        'heatmap.hide_monthly': 'Hide monthly',
        'heatmap.day_suffix': 'd',
...
export function applyTranslations() {
    ...
    // JSで動的生成された要素（セレクトのoption等）にも再翻訳を通知
